...
<html>
	...
	<div class="results">
		...
		while($row = mysqli_fetch_assoc($result)) {
			...
			<div  class="all <?php echo $row['schoolId'] ?> <?php echo str_replace(' ', '', $row['major']) ?>">
	...
	<select class="form-control" id="schoolMenu" style="width:400px; margin-bottom:100px; float:right;">
